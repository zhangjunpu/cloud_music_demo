  ...
  return (
    <FooterWrapped>
      ...
      <div className="info wrap_2">
        ...
        <div className="line2">
          <a href="https://jubao.163.com/" target="_blank" rel="noreferrer">廉正举报</a>
        ...
        <div className="line4">
          ...
          <a href="https://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010902002564" target="_blank" rel="noreferrer" className='icon'>police</a>
          <a href="https://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010902002564" target="_blank" rel="noreferrer">浙公网安备 33010902002564号</a>
        </div>
      </div>
    </FooterWrapped>
  )
