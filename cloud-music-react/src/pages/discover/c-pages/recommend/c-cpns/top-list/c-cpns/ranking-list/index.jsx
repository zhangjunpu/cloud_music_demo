    ...
    <RankingListWrapped>
      <div className="header">
        <div className="cover">
          ...
          <a href="/todo" className='sprite_cover'>{info.name}</a>
        </div>
        <div className="info">
          <a href="/todo" className='title'>{info.name}</a>
          <div className="funs">
            <a href="/todu" className='btn play sprite_02'>播放</a>
            <a href="/todu" className='btn fav sprite_02'>收藏</a>
          </div>
        </div>
      </div>
      <div className="list">
          ...
          info.tracks.slice(0, 10).map((item, i) => {
            return (
              <div key={item.id} className="item">
                ...
                <div className="info">
                  <a href="/todu" className='name text_nowrap'>{item.name}</a>
                  <div className="operate">
                    <a href="/todu" className='btn play sprite_02'>播放</a>
                    <a href="/todu" className='btn add sprite_icon'>添加</a>
                    <a href="/todu" className='btn fav sprite_02'>收藏</a>
                  </div>
                </div>
              </div>
