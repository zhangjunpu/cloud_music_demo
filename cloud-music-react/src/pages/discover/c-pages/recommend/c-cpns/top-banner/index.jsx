  ...
  return (
    <TopBannersWrapped bg={topBanners[curIndex] && topBanners[curIndex].imageUrl}>
      <div className="banner">
        ...
        <button className='btn left sprite_banner' onClick={e => bannerRef.current.prev()}>left</button>
        <button className='btn right sprite_banner' onClick={e => bannerRef.current.next()}>right</button>
      </div>
    </TopBannersWrapped>
  )
})
